...
\begin{frame}{Synthetic data}
	\begin{columns}[t]
		...
		Laplace prior
		\begin{figure}
			\includegraphics[width=1\columnwidth]{pres_pics/trace_laplace_w1.png}
		\end{figure}
	\vspace{-0.3cm}
		\begin{figure}
			\includegraphics[width=1\columnwidth]{pres_pics/trace_laplace_w2.png}
		\end{figure}
	\vspace{-0.3cm}
	\begin{figure}
	...
	\end{figure}
		...
		Cauchy prior
		\begin{figure}
			\includegraphics[width=1\columnwidth]{pres_pics/trace_cauchy_w1.png}
		\end{figure}
		\vspace{-0.3cm}
		\begin{figure}
			\includegraphics[width=1\columnwidth]{pres_pics/trace_cauchy_w2.png}
		\end{figure}
		\vspace{-0.3cm}
		\begin{figure}
